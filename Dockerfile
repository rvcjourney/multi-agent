...
ARG VITE_ICP_BUILDER_URL
ARG VITE_LINKEDIN_SCRAPER_URL
...
ENV VITE_ICP_BUILDER_URL=$VITE_ICP_BUILDER_URL
ENV VITE_LINKEDIN_SCRAPER_URL=$VITE_LINKEDIN_SCRAPER_URL
